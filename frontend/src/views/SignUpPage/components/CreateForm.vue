  ...
  <Card class="w-full max-w-md bg-background dark:bg-background border-none shadow-none">
    ...
    <CardContent class="grid gap-4">
      ...
      <div class="grid gap-2">
        ...
        <Input class="bg-white text-foreground dark:text-background" :class="{ 'border-red-500': usernameError }"
          id="username" type="username" v-model="username" placeholder="Username" />
